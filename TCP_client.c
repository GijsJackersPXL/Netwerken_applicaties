...
int initialization()
{
	...
	int getaddrinfo_return = getaddrinfo( "192.168.0.249", "24042", &internet_address_setup, &internet_address_result );
...
void execution( int internet_socket )
{
	...
	number_of_bytes_send = send( internet_socket, message, strlen(message), 0 );
